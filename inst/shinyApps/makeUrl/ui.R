  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      selectInput(inputId = "app",
                label = "app:",
                choices = c("", "/makeUrl", "/intensiv", "/nakke", "/noric", "/muskel")),
      selectInput(inputId = "user",
                  label = "user:",
                  choices = c("testUser1", "testUser2")),
      checkboxGroupInput(inputId = "groups",
                         label = "groups:",
                         choices = c("intensiv", "nakke", "muskel"),
                         selected = NULL),
      selectInput(inputId = "resh_id",
                  label = "resh_id:",
                  choices = c("muskel, UNN" = "101719", "123456" = "123456", "789012" = "789012", "101619" = "101619", "102966" = "102966",
